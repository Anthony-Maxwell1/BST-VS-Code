...
const studioWindows: bigint[] = [];

const enumProc = koffi.register((hwnd: bigint, _lParam: bigint) => {
...
const FindWindowW = user32.func(
  "void* __stdcall FindWindowW(const wchar_t* lpClassName, const wchar_t* lpWindowName)",
);
